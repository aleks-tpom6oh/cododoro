...
DateTime estimateWorkGoalTime(HistoryRepository historyRepository,
  ...
  //   double resTimetModificator = 1 + (settings.restDuration / settings.workDuration);

  //   Duration estimatedTimeTillGoal = workTimeTillGoal * resTimetModificator;

  //   DateTime estimatedEndTime = DateTime.now().add(estimatedTimeTillGoal);
