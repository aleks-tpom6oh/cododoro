...
import 'package:cododoro/notifications/local_notifications_notifier.dart';
import 'package:cododoro/notifications/sound_notifier.dart';
...
void syncSession(ElapsedTimeCubit elapsedTimeCubit, HistoryRepository history,
    TimerStateModel timerModel) {
  if (timerModel.isRunning()) {
    history.updateCurrentPomodoroSession(DateTime.now(),
        Duration(seconds: elapsedTimeCubit.state.elapsedTime.inSeconds));
  }
